...
public:
    ...
    wstring     Get_Element(BOSS eBoss)             { return m_KeyElement[m_HeroData[IDX(eBoss)].Element] + L"0"; }
    wstring     Get_Element_Line(BOSS eBoss)        { return m_KeyElement[m_HeroData[IDX(eBoss)].Element] + L"1"; }
